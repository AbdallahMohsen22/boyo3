...
class _ApiService implements ApiService {
  ...
  Future<List<ShopItemModel>> searchProduct(String productName) async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<ShopItemModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<SearchServiceModel>> searchService(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<SearchServiceModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<VehicleModel> addCaravan(
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<VehicleModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'multipart/form-data',
  ...
  Future<List<PackageModel>> getAllAdsPackages() async {
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<PackageModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<ServicePackageModel>> getUserServicesPackages(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<ServicePackageModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<UserAddPackageModel> userAddPackage(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UserAddPackageModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = UserAddPackageModel.fromJson(_result.data!);
    return value;
  }
  ...
  Future<UserAddServicePackageModel> userAddServicePackage(
    ...
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UserAddServicePackageModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = UserAddServicePackageModel.fromJson(_result.data!);
    return value;
  }

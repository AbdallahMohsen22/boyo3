...
class RentVehiclesWidget extends StatefulWidget {
  final String type1;
  RentVehiclesWidget({super.key, required this.type1});

  @override
  State<RentVehiclesWidget> createState() => _RentVehiclesWidgetState();
}

class _RentVehiclesWidgetState extends State<RentVehiclesWidget> {
  @override
  void initState() {
  ...
  void getAllRentCaravan(BuildContext context) {
    context.read<VehicleCubit>().emitGetAllVehicles(
          type1: widget.type1,
          type2: ApiConstants.rent,
        );
  }
  
  void getAllRentCaravanFilterByCountry(BuildContext context, String country) {

...
class GetWorkShopWidget extends StatefulWidget {
  GetWorkShopWidget({super.key});

  @override
  State<GetWorkShopWidget> createState() => _GetWorkShopWidgetState();
}

class _GetWorkShopWidgetState extends State<GetWorkShopWidget> {
  @override
  void initState() {
    getWorkshop(context);
    super.initState();
  ...
  void getWorkshop(BuildContext context) {
  ...
  void getServiceByCountry(BuildContext context,String country) {
    context.read<ServiceCubit>().emitGetServiceByCountry(
          servName: ApiConstants.workShop,
          country: country
        );
  }
}

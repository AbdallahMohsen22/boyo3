...
import 'package:boyo3_v1/features/home_features/screens/categories/services/add_service_widgets/add_workshop_fields.dart';
...
class AddWorkshopScreen extends StatelessWidget {
  ...
  void validateThenAddCar(BuildContext context) {
    if (context.read<ServiceCubit>().formKey.currentState!.validate()) {
      context.read<ServiceCubit>().emitGetAddWorkshops(userId:userId!,context: context);
    }
  }
}

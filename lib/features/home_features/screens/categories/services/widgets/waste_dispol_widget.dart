...
class WasteDispolWidget extends StatefulWidget {
  WasteDispolWidget({super.key});

  @override
  State<WasteDispolWidget> createState() => _WasteDispolWidgetState();
}

class _WasteDispolWidgetState extends State<WasteDispolWidget> {
  @override
  void initState() {

...
class WashingWidget extends StatefulWidget {
  WashingWidget({super.key});

  @override
  State<WashingWidget> createState() => _WashingWidgetState();
}

class _WashingWidgetState extends State<WashingWidget> {
  @override
  void initState() {
    getAllForMainWashingService(context);
    super.initState();
  }

...
import 'package:boyo3_v1/features/home_features/screens/categories/services/add_service_widgets/add_camping_fields.dart';
...
class AddCampingScreen extends StatelessWidget {
  const AddCampingScreen({super.key});
                      ...
                      onPressed: () {
                        userId== null || userId == ""
                            ...
                            : context.read<ServiceCubit>().image1 == null ||
                                ...
                                : context.read<ServiceCubit>().longitude == null ||
  ...
  void validateThenAddCar(BuildContext context) {
    if (context.read<ServiceCubit>().formKey.currentState!.validate()) {
      context.read<ServiceCubit>().emitGetAddCamping(userId:userId!,context: context);
    }
  }
}

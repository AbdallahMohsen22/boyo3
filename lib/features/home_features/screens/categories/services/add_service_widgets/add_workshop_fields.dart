...
class AddWorkshopsFields extends StatefulWidget {
  const AddWorkshopsFields({super.key});

  @override
  State<AddWorkshopsFields> createState() => _AddWorkshopsFieldsState();
}

class _AddWorkshopsFieldsState extends State<AddWorkshopsFields> {
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          // verticalSpace(10),
          //  DropDownButtonList(
          //   controller: context.read<ServiceCubit>().type2Controller,
          //   list: type2List,
          ...
          //     if (value == null ||
          //         value.isEmpty ) {
          //       return 'Please enter a countPerson';
          //     }
          //   },

...
import 'package:boyo3_v1/features/home_features/screens/drawer/drawer_screens/add_ads/add_cars/add_cars_widgets/add_car_fields.dart';
...
class AddCarsScreen extends StatelessWidget {
                      ...
                      onPressed: () {
                       userId == null || userId == ""
                            ...
                            : context.read<VehicleCubit>().image1 == null ||
                                ...
                                ? Constants.showErrorDialog(
                                    context: context,
                                    msg: "من فضلك قم بادخال صور ألسيارة اولا ")
  ...
  void validateThenAddCar(BuildContext context) {
    if (context.read<VehicleCubit>().formKey.currentState!.validate()) {
      context.read<VehicleCubit>().emitAddCar(id: userId!,context: context);
    }
  }
}

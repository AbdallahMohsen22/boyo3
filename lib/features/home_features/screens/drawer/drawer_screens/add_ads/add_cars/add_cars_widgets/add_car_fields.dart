...
class AddCarFields extends StatefulWidget {
  const AddCarFields({super.key});

  @override
  State<AddCarFields> createState() => _AddCarFieldsState();
}

class _AddCarFieldsState extends State<AddCarFields> {
        ...
        children: [
          ...
          AppTextFormField(
            ...
            validator: (value) {
              if (value == null ||
                  value.isEmpty ) {
                return 'من فضلك ادخل اسم السياره';
              }
            },
          ...
          AppTextFormField(
            ...
            validator: (value) {
              if (value == null ||
                  value.isEmpty ) {
                return 'من فضلك ادخل سعر السياره';
              }
            },
          ...
          AppTextFormField(
            ...
            validator: (value) {
              if (value == null ||
                  value.isEmpty ) {
                return 'من فضلك ادخل الكيلومترات';
              }
            },

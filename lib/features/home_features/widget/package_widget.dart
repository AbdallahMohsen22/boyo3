...
import 'package:boyo3_v1/features/home_features/screens/categories/packages/packages_screens/ads_packages_bloc_listener.dart';
...
class PackageWidget extends StatelessWidget {
  ...
  PackageWidget({super.key, required this.packageModel, required this.index});
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        userId == null || userId == ''
                            ...
                            : {
                                userAddPackage(
                                    context, packageModel.id, userId!),
  ...
  void userAddPackage(BuildContext context, int packageId, String userId) async {

    context.read<UserAddPackageCubit>().emitUserAddPackageStates(packageId: packageId, userId: userId);
    if (context.read<UserAddPackageCubit>().message == "Already Subscribed") {
      var prefs = await SharedPreferences.getInstance();
      adsPackageId = packageId;
      prefs.setInt('adsPackageId', packageModel.id);
    }
  }
}

...
class ForgetPasswordConfirmOtpFields extends StatefulWidget {
  const ForgetPasswordConfirmOtpFields({super.key});

  @override
  State<ForgetPasswordConfirmOtpFields> createState() => _ForgetPasswordConfirmOtpFieldsState();
}

class _ForgetPasswordConfirmOtpFieldsState extends State<ForgetPasswordConfirmOtpFields> {
...
final defaultPinTheme = PinTheme(
 ...
 void validateThenDoRegister(BuildContext context) {
    if (context.read<ForgetPasswordCubit>().formKey.currentState!.validate()) {
      context.read<ForgetPasswordCubit>().emitConfirmOtp();
    }
  }

...
class ForgetPasswordConfirmEmailBlocListener extends StatelessWidget {
  const ForgetPasswordConfirmEmailBlocListener({super.key});
      ...
      listener: (context, state) {
        state.whenOrNull(
          ...
          success: (registerResponse) {
            ...
            context.pop();
            context.pushNamed(Routes.forgetPasswordConfirmOtp);
          },
          error: (error) {

...
class EulaScreenLogin extends StatefulWidget {
  const EulaScreenLogin({super.key});

  @override
  _EulaScreenLoginState createState() => _EulaScreenLoginState();
}

class _EulaScreenLoginState extends State<EulaScreenLogin> {
...
5. **الخصوصية**:
يخضع استخدام التطبيق لسياسة الخصوصية الخاصة بنا، والتي يمكن العثور عليها على: https://backend.boyo3.com.com/en_us/privacy-policy-2/. باستخدام التطبيق، فإنك توافق على جمع المعلومات واستخدامها وفقًا لسياسة الخصوصية.
                  ...
                  child: GestureDetector(
                    ...
                    child:  Text(
                      HomeCubit.get(context).isArabic
                          ? "أوافق على شروط وأحكام اتفاقية ترخيص المستخدم النهائي"
                          : 'I agree to the EULA terms and conditions',

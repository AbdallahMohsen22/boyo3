...
class EulaScreenRegister extends StatefulWidget {
  const EulaScreenRegister({super.key});

  @override
  _EulaScreenRegisterState createState() => _EulaScreenRegisterState();
}

class _EulaScreenRegisterState extends State<EulaScreenRegister> {
